...
@section('title', 'Admin - Support Tickets | DevConnect')
...
<main class="flex-grow max-w-container-max mx-auto w-full px-margin-desktop py-stack-lg">
    <div class="flex justify-between items-center mb-stack-md">
        <div>
            <h1 class="text-headline-lg font-headline-lg text-on-surface">Support Tickets (Admin)</h1>
            <p class="text-body-md text-on-surface-variant">Manage and respond to user support requests.</p>
        </div>
        <a href="{{ route('admin.dashboard') }}" class="text-primary hover:underline font-semibold flex items-center gap-1">
                    ...
                    <tbody class="divide-y divide-outline-variant">
                        @foreach($tickets as $ticket)
                            <tr class="hover:bg-surface-container-lowest transition-colors">
                                ...
                                <td class="p-4">
                                    <a href="{{ route('admin.tickets.show', $ticket) }}" class="text-primary hover:underline font-semibold flex items-center gap-1">
                                        Manage

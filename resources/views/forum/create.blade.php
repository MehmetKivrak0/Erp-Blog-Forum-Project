    ...
    <form id="create-topic-form" action="{{ route('forum.create.post') }}" method="POST" class="flex gap-gutter w-full">
        ...
        <article class="flex-grow max-w-[840px]">
            ...
            <div class="mb-stack-md">
                <input autofocus="" name="title" class="w-full bg-transparent border-none focus:ring-0 p-0 font-headline-xl text-headline-xl text-on-surface placeholder:text-outline-variant outline-none border-b border-transparent focus:border-outline-variant pb-2" placeholder="Topic Title" type="text" required/>
            </div>
            ...
            <!-- Main Content Area -->
            <div class="relative">
                <textarea name="content" class="w-full min-h-[500px] bg-transparent border-none focus:ring-0 p-0 font-body-lg text-body-lg text-on-surface placeholder:text-outline-variant resize-none leading-relaxed outline-none" placeholder="Describe your topic or question here..." required></textarea>
            </div>
        </article>
        <!-- Sidebar Settings -->
